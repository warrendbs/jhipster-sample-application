...
export interface IPartIntention {
  id?: number;
...
export class PartIntention implements IPartIntention {
  constructor(
    public id?: number,
...
export function getPartIntentionIdentifier(partIntention: IPartIntention): number | undefined {
  return partIntention.id;
}
