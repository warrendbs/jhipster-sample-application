...
class DocumentResourceIT {
    ...
    public static Document createEntity(EntityManager em) {
        Document document = new Document().title(DEFAULT_TITLE).status(DEFAULT_STATUS);
        return document;
    }
    ...
    public static Document createUpdatedEntity(EntityManager em) {
        Document document = new Document().title(UPDATED_TITLE).status(UPDATED_STATUS);
        return document;
    }
    ...
    void putNewDocument() throws Exception {
        ...
        updatedDocument.title(UPDATED_TITLE).status(UPDATED_STATUS);
    ...
    void partialUpdateDocumentWithPatch() throws Exception {
        ...
        partialUpdatedDocument.title(UPDATED_TITLE).status(UPDATED_STATUS);
